...
Покрывает:
  - Граничные случаи (пустой массив, константа)
  - Базовая статистика (мин, макс, среднее)
  - Подсчёт циклов (синус, известные пики)
  - Формула Минера: эквивалентный полуразмах
  - Влияние показателя m
  - Квазистатические границы
